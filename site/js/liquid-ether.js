/* =========================================================
   LiquidEther — vanilla JS port (from React Bits component)
   WebGL fluid simulation. Requires three.js (loaded via ESM CDN).

   Usage:
     import { createLiquidEther } from './js/liquid-ether.js';
...
export function createLiquidEther(mount, props = {}) {
  ...
  // ref-like containers (ported from React refs)
  ...
  if (!mountRef.current) return function () {};
...
`;
  ...
  class WebGLManager {
    constructor(managerProps) {
      this.props = managerProps;
      Common.init(managerProps.$wrapper);
      Mouse.init(managerProps.$wrapper);
      Mouse.autoIntensity = managerProps.autoIntensity;
      Mouse.takeoverDuration = managerProps.takeoverDuration;
      ...
      this.autoDriver = new AutoDriver(Mouse, this, {
        enabled: managerProps.autoDemo,
        speed: managerProps.autoSpeed,
        resumeDelay: managerProps.autoResumeDelay,
        rampDuration: managerProps.autoRampDuration
      });
      this.init();
